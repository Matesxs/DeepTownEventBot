...
class CreateQuestionAndAnswer(disnake.ui.Modal):
  def __init__(self, default_question: Optional[str]=None, default_answer: Optional[str]=None):
    components = [
      disnake.ui.TextInput(label="Question", custom_id="q_and_a:question", value=default_question, required=True, max_length=3000, placeholder="Place here your question", style=disnake.TextInputStyle.multi_line),
      disnake.ui.TextInput(label="Answer", custom_id="q_and_a:answer", value=default_answer, required=True, max_length=3000, placeholder="Place here your answer", style=disnake.TextInputStyle.multi_line)
    ]
