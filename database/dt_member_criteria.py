...
async def have_participation_elsewhere(user_id: int, guild_id: int, event_year: int, event_week: int, amount: int) -> bool:
  result = await run_query(select(EventParticipation)
