...
async def get_or_fetch_message(bot: commands.AutoShardedBot, source: Optional[Union[disnake.VoiceChannel, disnake.StageChannel, disnake.TextChannel, disnake.CategoryChannel, disnake.ForumChannel, disnake.Thread, disnake.User, disnake.PartialMessageable]], message_id: int) -> Optional[disnake.Message]:
